...
<img alt="start page background photo" src="./src/img/readme/start.png" width="850">
...
<img alt="start page background photo" src="./src/img/readme/tasks.png" width="850">
...
1. Create your unique account
   - Change settings like avatar, full name, nick, date of birth, phone number, email
   - Change your main colour theme (light, dark).
2. Plan and manage your tasks
   - Add them explicitly by quick form or by drag'n'dropping selected hours/days.
   - Update/Delete them with one click.
   - Filter and sort through them with basic and advanced tools.
